...
WORKSHOPS = {
    ...
    'half-day-conference-workshop': [
        ...
        ('task_17_using_DAGMC_models_in_openmc/dagmc.h5m', 'dagmc.h5m'),
        ('task_18_CAD_mesh_fast_flux/1_simulate_fast_neutron_flux_on_cad.ipynb', 'task_13.ipynb'),
        ('task_18_CAD_mesh_fast_flux/dagmc_for_um.h5m', 'dagmc_for_um.h5m'),
        ('task_18_CAD_mesh_fast_flux/dagmc.vtk', 'dagmc.vtk'),
